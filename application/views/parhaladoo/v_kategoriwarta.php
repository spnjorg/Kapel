...
<head>
  ...
  <title>HKBP II - Kategori Warta</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'parhaladoo/kategoriwarta'?>"><i class="fa fa-star-o fa-pulse"></i> Kategori Warta</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Kategori Warta Jemaat</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Kategori Warta</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <?php
          ...
          foreach ($data->result_array() as $i) :
             $no++;
                       $id=$i['kategori_warta_id'];
                       $nama=$i['kategori_warta_nama'];
                    ?>
                <tr>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Add Kategori Warta</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/kategoriwarta/simpan_kwarta'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Kategori</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xkategoriwarta" class="form-control" id="inputUserName" placeholder="Kategori" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/kategoriwarta/update_kwarta'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                      ...
                      <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                            <input type="text" name="xkategoriwarta" class="form-control" id="inputUserName" value="<?php echo $nama;?>" placeholder="Kategori" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/kategoriwarta/hapus_kwarta'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
              <input type="hidden" name="kode" value="<?php echo $id;?>"/>
