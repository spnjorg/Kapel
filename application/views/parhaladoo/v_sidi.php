...
<head>
  ...
  <title>HKBP II - Berita Peneguhan Sidi</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'parhaladoo/sidi'?>"><i class="fa fa-star-o fa-pulse"></i> Peneguhan Sidi</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Berita Peneguhan Sidi Anak Gereja
        <small></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal" style="background-color: darkcyan; color: white; margin-top: 5px; "><span class="fa fa-plus"></span> Tambah Data</a>        
               ...
               <!-- <form class="form-horizontal" action="<?php echo base_url().'admin/laporan/laporan_datasidi'?>" method="post" enctype="multipart/form-data"> 
                ...
                <tbody>
                  <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       ...
                       $jemaat_id=$i['sidi_jemaat_id'];
                       $nama=$i['jemaat_nama'];
                       $jenkel=$i['jemaat_jenkel'];
                       $tmptlahir=$i['jemaat_tmptlahir'];
                       $tgllahir=$i['jemaat_tgllahir'];
                       $tardidi=$i['jemaat_tgltardidi'];
                       $tgltardidi= date('d F Y', strtotime($tardidi));
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/sidi/simpan_sidi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tanggal</label>
                                        <div class="col-sm-7">
                                            <input type="date" name="xtanggal" class="form-control" id="inputUserName" placeholder="Contoh: Tahun-bulan-hari (2000-01-01)" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xham" class="form-control" id="inputUserName" placeholder="Contoh: 250,000" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/sidi/update_sidi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tanggal</label>
                                        <div class="col-sm-7">
                                            <input type="date" name="xtanggal" value="<?php echo $tanggal;?>" class="form-control" id="inputUserName" placeholder="Contoh: Tahun-bulan-hari (2000-01-01)" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Hamuliateon</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xham" value="<?php echo $ham;?>" class="form-control" id="inputUserName" placeholder="Contoh: 250,000" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/sidi/hapus_sidi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                            <p>Apakah Anda yakin mau menghapus <b><?php echo $nama;?></b> dari data Peneguhan Sidi?</p>
