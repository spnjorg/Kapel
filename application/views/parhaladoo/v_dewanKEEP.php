      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'parhaladoo/dewan'?>"><i class="fa fa-star-o fa-pulse"></i> Anggota Dewan</a></li>
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Dewan</a>
               <ul class="pull-right"><a href="<?php echo base_url('parhalado/laporan/laporan_dewan');?>" class="btn btn-flat" style="background-color: darkcyan; color: white;"><span class="glyphicon glyphicon-save fa fa-print"></span> PRINT </a>
               </ul>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<!-- ./wrapper -->
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/Dewan/simpan_dewan'?>" method="post" enctype="multipart/form-data">
  ...
  <?php foreach ($data->result_array() as $i) :
                       $id=$i['dewan_id'];
                       $dewanparhalado_id=$i['dewanparhalado_id'];
                       $nama=$i['parhalado_nama'];
                       $dewankat_id=$i['dewankat_id'];
                       $dewan=$i['kdewan_nama'];
                       $jabatan=$i['dewan_jabatan'];
                       $photo=$i['parhalado_photo'];
            ?>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/dewan/update_dewan'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/dewan/hapus_dewan'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
