        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <label class="label-control"><h4>Filter Berdasarkan : </h4></label>
               <ul class="pull-right"><a href="<?php echo base_url('parhaladoo/laporan/laporan_ama');?>" class="btn btn-flat" style="background-color: darkcyan; color: white;"><span class="glyphicon glyphicon-save fa fa-print"></span> PRINT </a>
               </ul>   

               <a class="btn btn-flat" href="<?php echo base_url().'parhaladoo/ama'?>" style="background-color: lightcyan; color: black">Ama</a>
               <a class="btn btn-success btn-flat" href="<?php echo base_url().'parhaladoo/ina'?>" style="background-color: darkcyan; color: white">Ina</a>
               <a class="btn btn-success btn-flat" href="<?php echo base_url().'parhaladoo/naposo'?>" style="background-color: darkcyan; color: white">Naposo</a>
