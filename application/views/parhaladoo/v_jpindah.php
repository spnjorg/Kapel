...
<head>
  ...
  <title>HKBP II - Jemaat Pindah Huria</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'parhaladoo/jpindah'?>"><i class="fa fa-star-o fa-pulse"></i> Pindah Jemaat</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Daftar Jemaat Yang Pindah Huria
        <small></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal" style="background-color: darkcyan; color: white; margin-top: 5px; "><span class="fa fa-plus"></span> Tambah Data</a>   
              ...
              <!--  <form class="form-horizontal" action="<?php echo base_url().'admin/laporan/laporan_jpindah'?>" method="post" enctype="multipart/form-data"> 
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Tambah Jemaat Pindah Huria</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/jpindah/simpan_jpindah'?>" method="post" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Data Jemaat Yang Pindah</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/jpindah/update_jpindah'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">ID Keluarga</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xidkeluarga" value="<?php echo $kk_id;?>" class="form-control" id="inputUserName" placeholder="Nama Lengkap Ayah" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tu Huria</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xtujuan" value="<?php echo $tujuan;?>" class="form-control" id="inputUserName" placeholder="Pindah Ke Huria..." required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus Data Pindahan</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/jpindah/hapus_jpindah'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                            <p>Apakah Anda yakin mau menghapus data pindah dari keluarga <b><?php echo $username;?></b> ?</p>
