      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
        ...
        <li class="active">
          <a href="<?php echo base_url().'parhaladoo/inbox'?>">
            <i class="fa fa-star-o fa-pulse"></i> <span>Inbox</span>
            <span class="pull-right-container">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $inbox_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/inbox/hapus_inbox'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
