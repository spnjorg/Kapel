...
<head>
  ...
  <title>HKBP II - Berita Tardidi</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'parhaladoo/tardidi'?>"><i class="fa fa-star-o fa-pulse"></i> Tardidi</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal" style="background-color: darkcyan; color: white; margin-top: 5px; "><span class="fa fa-plus"></span> Tambah Data</a>       
              ...
              <!--  <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/laporan/laporan_datatardidi'?>" method="post" enctype="multipart/form-data"> 

                  <div class="col-md-2 col-sm-2 col-xs-6" style="margin-top:-15px;">
                    <span style="font-size: xx-small;">Pilih Bulan :</span>
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-6" style="margin-top:-15px;">
                    <span style="font-size: xx-small;">Pilih Tahun :</span>
                ...
                <tbody>
                  <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       $no++;
                       $id=$i['tardidi_id'];
                       $tanggal=$i['tardidi_tgl'];
                       $kk_id=$i['tardidi_kk_id'];
                       $nama=$i['tardidi_nama'];
                       $jenkel=$i['tardidi_jenkel'];
                       $keluarga=$i['kk_username'];
                       $tgllahir=$i['tardidi_tgllahir'];
                       $tmptlahir=$i['tardidi_tmptlahir'];
                       $alamat=$i['kk_alamat'];
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Tambah Data Tardidi</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/tardidi/simpan_tardidi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tanggal Tardidi</label>
                                        <div class="col-sm-7">
                                            <input type="date" name="xtgltardidi" class="form-control" id="inputUserName" placeholder="Tanggal Tardidi" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="date" name="xtgllahir" class="form-control" id="inputUserName" placeholder="Tanggal Lahir" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Data Tardidi</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/tardidi/update_tardidi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tanggal Tardidi</label>
                                        <div class="col-sm-7">
                                            <input type="date" name="xtgltardidi" value="<?php echo $tanggal;?>" class="form-control" id="inputUserName" placeholder="Nama Lengkap" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tempat Lahir</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xtmptlahir" value="<?php echo $tmptlahir;?>" class="form-control" id="inputUserName" placeholder="Tepat Lahir" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tanggal Lahir</label>
                                        <div class="col-sm-7">
                                            <input type="date" name="xtgllahir" value="<?php echo $tgllahir;?>" class="form-control" id="inputUserName" placeholder="Contoh: Tahun-bulan-hari (2000-01-01)" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus Data Tardidi</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/tardidi/hapus_tardidi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                            <p>Apakah Anda yakin mau menghapus <b><?php echo $nama;?></b> dari data tardidi?</p>
