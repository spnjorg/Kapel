          ...
          <div class="box">
            <div class="box-header">
              ...
              <label class="label-control"><h4>Filter Berdasarkan : </h4></label>
               <ul class="pull-right"><a href="<?php echo base_url('parhaladoo/laporan/laporan_ina');?>" class="btn btn-flat" style="background-color: darkcyan; color: white;"><span class="glyphicon glyphicon-save fa fa-print"></span> PRINT </a>
               </ul> 

               <a class="btn btn-flat" href="<?php echo base_url().'parhaladoo/ama'?>" style="background-color: darkcyan; color: white">Ama</a>
               <a class="btn btn-flat" href="<?php echo base_url().'parhaladoo/ina'?>" style="background-color: lightcyan; color: black">Ina</a>
