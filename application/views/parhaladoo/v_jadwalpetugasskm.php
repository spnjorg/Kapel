        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <label class="label-control"><h4>Petugas Ibadah : </h4></label>
               ...
               <a class="btn btn-flat" href="<?php echo base_url().'parhaladoo/jadwalpetugas'?>" style="background-color: darkcyan; color: white;"> Minggu Umum</a>
               <a class="btn  btn-flat" href="<?php echo base_url().'parhaladoo/jadwalpetugas/skm'?>" style="background-color: lightcyan; color: black;"> Sekolah Minggu</a>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/jadwalpetugas/simpan_petugasskm'?>" method="post" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="ModalEdit<?php echo $petugas;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/jadwalpetugas/update_petugasskm'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $petugas;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/jadwalpetugas/hapus_petugasskm'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
              <input type="hidden" name="kode" value="<?php echo $petugas;?>"/>
