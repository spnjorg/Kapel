...
<head>
  ...
  <title>HKBP II - Kategori Renungan</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'admin/kategori'?>"><i class="fa fa-spinner fa-pulse"></i> Kategori</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Kategori Renungan</li>
      </ol>
    </section>
