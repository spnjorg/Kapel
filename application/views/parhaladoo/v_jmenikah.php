...
<head>
  ...
  <title>HKBP II - Jemaat Hendak Menikah</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'parhaladoo/jmenikah'?>"><i class="fa fa-star-o fa-pulse"></i> Menikah</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Daftar Ruas Ni Huria Namarhasohotan
        <small></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal" style="background-color: darkcyan; color: white; margin-top: 5px; "><span class="fa fa-plus"></span> Tambah Data</a>         
               ...
               <!-- Bagian Select by Tanggal--> 
              <!--  <form class="form-horizontal" action="<?php echo base_url().'admin/laporan/laporan_jmenikah'?>" method="post" enctype="multipart/form-data"> 

                  <div class="col-md-2 col-sm-2 col-xs-6" style="margin-top:-15px;">
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-6" style="margin-top:-15px;">
                    ...
                    <input class="form-control" type="date" name="xtglakhir" placeholder="Tanggal Akhir"requiredd> 
                        ...
                        <ul>
                        <button type="submit" class="btn btn-flat" id="simpan" style="background-color: darkcyan; color: white; margin-top: 5px; "> <span class="glyphicon glyphicon-save fa fa-print"></span> Cetak Laporan</button>
                        <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal" style="background-color: darkcyan; color: white; margin-top: 5px; "><span class="fa fa-plus"></span> Tambah Data</a>
                        </ul>
                  </form> -->
                ...
                <tbody>
                  <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       $no++;
                       $id=$i['jmenikah_id'];
                       $jemaat_id=$i['jmenikah_jemaat_id'];
                       $nama=$i['jemaat_nama'];
                       $namapasangan=$i['jmenikah_namapasangan'];
                       $username=$i['kk_username'];
                       $alamat=$i['kk_alamat'];
                       $lingkungan_nama=$i['lingkungan_nama'];
                       $huria=$i['jmenikah_huria'];
                       $tanggal=$i['jmenikah_tglnikah'];
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Tambah Data Jemaat Yang hendak Menikah</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/jmenikah/simpan_jmenikah'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tanggal Nikah</label>
                                        <div class="col-sm-7">
                                            <input type="date" name="xtglnikah" class="form-control" id="inputUserName" placeholder=" Tanggal" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nama Pasangan</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnamapasangan" class="form-control" id="inputUserName" placeholder="Nama Pasangan" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xhuria" class="form-control" id="inputUserName" placeholder="Huria" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Data Jemaat Yang Hendak Menikah</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/jmenikah/update_jmenikah'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="date" name="xtglnikah" value="<?php echo $tanggal;?>" class="form-control" id="inputUserName" placeholder="Tanggal" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">ID Jemaat</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xidjemaat" value="<?php echo $jemaat_id;?>" class="form-control" id="inputUserName" placeholder="Masukkan ID Jemaat" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nama Pasangan</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnamapasangan" value="<?php echo $namapasangan;?>" class="form-control" id="inputUserName" placeholder="Goar Nioroan" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus Data Pernikahan</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/jmenikah/hapus_jmenikah'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                            <p>Apakah Anda yakin mau menghapus data pernikahan dari <b><?php echo $nama;?> dan <?php echo $namapasangan;?></b> ?</p>
