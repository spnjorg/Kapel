...
<head>
  ...
  <title>HKBP II - Update Renungan</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'admin/renungan/add_renungan'?>"><i class="fa fa-spinner fa-pulse"></i> Post Renungan</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Update Renungan</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Update Renungan</h3>
        </div>
		<?php
        $b=$data->row_array();
    ?>
		<form action="<?php echo base_url().'admin/renungan/update_renungan'?>" method="post" enctype="multipart/form-data">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              ...
              <input type="text" name="xjudul" class="form-control" value="<?php echo $b['renungan_judul'];?>" placeholder="Judul Renungan atau Postingan" required/>
            </div>
            <!-- /.col -->
            <div class="col-md-2">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Renungan</h3>
            </div>
            <div class="box-body">

			       <textarea id="ckeditor" name="xisi" required><?php echo $b['renungan_isi'];?></textarea>
                  ...
                  <option value="">-Pilih-</option>
        				  <?php
        					foreach ($kat->result_array() as $i) {
                               ...
                               if($b['renungan_kategori_id']==$kategori_id)
