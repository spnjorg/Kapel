  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small> - NASORANG (Anak Lahir)</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
        <li>Warta Jemaat</li>
        <li>Warta Jemaat</li>
        <li class="active">Nasorang</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <label class="label-control"><h4>Kategori Warta : </h4></label>
               ...
               <a class="btn btn-flat" href="<?php echo base_url().'parhaladoo/wartafix'?>" style="background-color: lightcyan; color: black">Nasorang</a>
