    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'parhaladoo/kelahiran'?>"><i class="fa fa-star-o fa-pulse"></i> Kelahiran</a></li>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                    <th>No.</th>
                    <th style="text-align:center">ID Keluarga</th>
                ...
                <tbody>
                  <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       ...
                       $kelahiran_id=$i['kelahiran_kk_id'];
                ...
                <tr>
                  <td><?php echo $no;?></td>
                  <td style="text-align:center"><?php echo $kelahiran_id;?></td>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/kelahiran/simpan_kelahiran'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">ID Keluarga</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xidkel" class="form-control" id="inputUserName" placeholder="Masukkan ID Keluarga" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/kelahiran/update_kelahiran'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">ID Keluarga</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xidkel" value="<?php echo $kelahiran_id;?>" class="form-control" id="inputUserName" placeholder="Masukkan ID Keluarga" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/kelahiran/hapus_kelahiran'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                            <p>Apakah Anda yakin mau menghapus data kelahiran dari keluarga <b><?php echo $username;?></b> ?</p>
