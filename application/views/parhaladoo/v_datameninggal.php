...
<head>
  ...
  <title>HKBP II - Berita Jemaat Meninggal</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'parhaladoo/datameninggal'?>"><i class="fa fa-star-o fa-pulse"></i> Meninggal Dunia</a></li>
          ...
          <div class="box">
            <div class="box-header">
             ...
             <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal" style="background-color: darkcyan; color: white; margin-top: 5px; "><span class="fa fa-plus"></span> Tambah Data</a>       
               ...
               <!-- <form class="form-horizontal" action="<?php echo base_url().'admin/laporan/laporan_datameninggal'?>" method="post" enctype="multipart/form-data"> 
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tbody>
                  <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       $no++;
                       $id=$i['meninggal_id'];
                       $jemaat_id=$i['meninggal_jemaat_id'];
                       $tanggal=$i['meninggal_tgl'];
                       $tanggal_new= date('d F Y', strtotime($tanggal));
                       $nama=$i['jemaat_nama'];
                       $usia_id=$i['meninggal_katfilter_id'];
                       $usia_nama=$i['katfilter_nama'];
                       $usia=$i['Umur'];
                       $alamat=$i['kk_alamat'];
                ...
                <tr>
                  <td><?php echo $no;?></td>
                  <td style="text-align:center;"><?php echo $tanggal_new;?></td>
                  <td><?php echo $nama;?></td>
                  <td><?php echo $usia_nama;?></td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Tambah Data Jemaat Yang Meninggal Dunia</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/datameninggal/simpan_datameninggal'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                          <select name="xkatusia" class="form-control" required>
                                            <option value="">-Pilih-</option>
                                            <?php
                                                foreach ($katusia->result_array() as $k) {
                                                  $id=$k['katfilter_id'];
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Data Jemaat Yang Meninggal Dunia</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/datameninggal/update_datameninggal'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/datameninggal/hapus_datameninggal'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                            <p>Apakah Anda yakin mau menghapus data jemaat <b><?php echo $nama;?> dari Berita Meninggal Dunia</b> ?</p>
