...
<head>
  ...
  <title>HKBP II - List Renungan</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'admin/renungan'?>"><i class="fa fa-spinner fa-pulse"></i> List Renungan</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url().'admin/jemaat'?>"><i class="fa fa-list"></i>Jemaat</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'admin/renungan'?>"><i class="fa fa-list"></i> List Warta</a></li>
            <li><a href="<?php echo base_url().'admin/renungan/add_renungan'?>"><i class="fa fa-thumb-tack"></i> Post Warta</a></li>
            <li><a href="<?php echo base_url().'admin/kategori'?>"><i class="fa fa-wrench"></i> Kategori Warta</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">List Renugan</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/renungan/add_renungan'?>"><span class="fa fa-plus"></span> Post Renungan</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
          				<?php
          					...
          					foreach ($data->result_array() as $i) :
          					   ...
          					   $renungan_isi=$i['renungan_isi'];
          					   $renungan_tanggal=$i['tanggal'];
          					   $renungan_author=$i['renungan_author'];
          					   $renungan_gambar=$i['renungan_gambar'];
          					   $renungan_views=$i['renungan_views'];
                       $kategori_id=$i['renungan_kategori_id'];
                       $kategori_nama=$i['renungan_kategori_nama'];

                    ?>
                <tr>
                  <td><img src="<?php echo base_url().'assets/images/'.$renungan_gambar;?>" style="width:90px;"></td>
                  <td><?php echo $renungan_judul;?></td>
        				  <td><?php echo $renungan_tanggal;?></td>
        				  <td><?php echo $renungan_author;?></td>
        				  <td><?php echo $renungan_views;?></td>
        				  <td><?php echo $kategori_nama;?></td>
                  <td style="text-align:right;">
                        <a class="btn" href="<?php echo base_url().'admin/renungan/get_edit/'.$renungan_id;?>"><span class="fa fa-pencil"></span></a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Hapus Renungan</h4>
                    </div>
                    ...
                    <div class="modal-body">
                     ...
                     <input type="hidden" value="<?php echo $renungan_gambar;?>" name="gambar">
                            <p>Apakah Anda yakin mau menghapus Posting <b><?php echo $renungan_judul;?></b> ?</p>
