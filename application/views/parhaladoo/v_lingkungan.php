...
<head>
  ...
  <title>HKBP II - Lingkungan</title>
        ...
        <li>
         ...
         <li class="active">
          <a href="<?php echo base_url().'parhaladoo/lingkungan'?>">
            <i class="fa fa-star-o fa-pulse"></i> <span>Lingkungan</span>
            <span class="pull-right-container">
              <small class="label pull-right"></small>
            </span>
          </a>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Lingkungan</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <?php
          ...
          foreach ($data->result_array() as $i) :
             $no++;
                       $lingkungan_id=$i['lingkungan_id'];
                       $lingkungan_nama=$i['lingkungan_nama'];
                       $lingkungan_jalan=$i['lingkungan_jalan'];
                    ?>
                <tr>
                  <td><?php echo $no;?></td>
                  <td><?php echo $lingkungan_id;?></td>
                  <td><?php echo $lingkungan_nama;?></td>
                  <td><?php echo $lingkungan_jalan;?></td>

                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $lingkungan_id;?>"><span class="fa fa-pencil"></span></a>
                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $lingkungan_id;?>"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
        <?php endforeach;?>
                </tbody>
...
<!--Modal Add Pengguna-->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Add Lingkungan</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/lingkungan/simpan_lingkungan'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">ID Lingkungan</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xid" class="form-control" id="inputUserName" placeholder="Contoh : IA" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xlingkungan" class="form-control" id="inputUserName" placeholder="Lingkungan" required>
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xjalan" class="form-control" id="alamat" placeholder="Jalan" required>
                                        </div>
                                    </div>
                    </div>
    ...
    <?php foreach ($data->result_array() as $i) :
            ...
            ?>
  <!--Modal Edit Pengguna-->
        <div class="modal fade" id="ModalEdit<?php echo $lingkungan_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Lingkungan</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/lingkungan/update_lingkungan'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">ID Lingkungan</label>
                                        <div class="col-sm-7">
                                            <input type="hidden" name="kode" value="<?php echo $lingkungan_id;?>"/>
                                            <input type="text" name="xid" class="form-control" id="inputUserName" value="<?php echo $lingkungan_id;?>" placeholder="Contoh : IA" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="hidden" name="kode" value="<?php echo $lingkungan_id;?>"/>
                                            <input type="text" name="xlingkungan" class="form-control" id="inputUserName" value="<?php echo $lingkungan_nama;?>" placeholder="Lingkungan" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="hidden" name="kode" value="<?php echo $lingkungan_id;?>"/>
                                            <input type="text" name="xjalan" class="form-control" id="inputUserName" value="<?php echo $lingkungan_jalan;?>" placeholder="Alamat" required>
                                        </div>
                                    </div>
  ...
  <!--Modal Hapus Pengguna-->
        <div class="modal fade" id="ModalHapus<?php echo $lingkungan_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/lingkungan/hapus_lingkungan'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
              <input type="hidden" name="kode" value="<?php echo $lingkungan_id;?>"/>
                            <p>Apakah Anda yakin mau menghapus <b><?php echo $lingkungan_nama;?></b> ?</p>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Lingkungan Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Lingkungan berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Lingkungan Berhasil dihapus.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
