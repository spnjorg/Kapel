          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Dewan</a>
               <ul class="pull-right"><a href="<?php echo base_url('parhaladoo/laporan/laporan_dewan');?>" class="btn btn-flat" style="background-color: darkcyan; color: white;"><span class="glyphicon glyphicon-save fa fa-print"></span> PRINT </a>
               </ul>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
