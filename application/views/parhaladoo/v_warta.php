...
<head>
  ...
  <title>HKBP II - List Warta Jemaat (Convert From WhatsApp Gateway)</title>
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'parhaladoo/warta'?>"><i class="fa fa-star-o fa-pulse"></i> List Warta</a></li>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <!-- <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Warta jemaat</a> -->
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <?php
          ...
          $no=0;
            foreach ($datawartain->result_array() as $i) :
               $no++;
                       $id=$i['wartain_id'];
                       $nama=$i['pewarta_nama'];
                       $tanggal=$i['wartain_tanggal'];
                       $tanggal_new= date('d F Y', strtotime($tanggal));
                       $notelp=$i['wartain_notelp'];
                       $isi=$i['wartain_isi'];
                ...
                <tr>
                  ...
                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalAddkat<?php echo $id;?>"><span class="fa fa-plus"></span></a>
...
<!--Modal Add Pengguna-->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Add Warta Jemaat</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/warta/simpan_warta'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Isi Pesan Warta</label>
                                <div class="col-sm-7">
                                  <textarea class="form-control" rows="3" name="xisi" placeholder="Deskripsi ..." required></textarea>
                                </div>
                            </div>
    ...
    <!-- <?php foreach ($datawartain->result_array() as $i) :
              $id=$i['wartain_id'];
                       $nama=$i['wartain_nama'];
                       $tanggal=$i['wartain_tanggal'];
                       $notelp=$i['wartain_notelp'];
...
<!--         <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit warta</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/warta/update_warta'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                            <input type="text" name="xjudul" class="form-control" id="inputUserName" value="<?php echo $judul;?>" placeholder="Contoh : Tinting I" required>
                                        </div>
                                    </div>
                              ...
                              <div class="col-sm-7">
                                <div class="input-group date">
                                  ...
                                  <input type="text" name="xtanggal" value="<?php echo $tanggal;?>" class="form-control pull-right datepicker3" required>
                                </div>
                              </div>
                            </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus Warta</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/warta/hapus_warta'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
              <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                            <p>Apakah Anda yakin mau menghapus Warta <b><?php echo $nama;?> : <?php echo $isi;?></b> ?</p>
  ...
  <!-- MENAMBAH WARTA SESUAI KATEGORI -->
  ...
  <?php foreach ($datawartain->result_array() as $i) :
            ...
            ?>
  <!--Modal Edit Pengguna-->
        <div class="modal fade" id="ModalAddkat<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Add Warta Berdasarkan Kategori</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'parhaladoo/wartafix/simpan_walist'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                       <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                            <input type="text" name="xtanggal" class="form-control" id="inputUserName" value="<?php echo $tanggal;?>" placeholder="Tanggal" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                       <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                            <input type="text" name="xnama" class="form-control" id="inputUserName" value="<?php echo $nama;?>" placeholder="Nama Pewarta" required>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Isi Pesan</label>
                                        <div class="col-sm-7">
                                       <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                           <!--  <input type="text" name="xisi" class="form-control" id="inputUserName" value="<?php echo $isi;?>" placeholder="Isi Warta" required> -->
                                           <textarea class="form-control" rows="3" name="xisi" placeholder="Isi Warta Jemaat ..." required><?php echo $isi;?></textarea>
                                        </div>
                                    </div>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='berhasil'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Warta Berhasil disimpan ke Halaman Warta Perkategori.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
