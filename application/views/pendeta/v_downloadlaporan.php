...
<head>
  ...
  <title>HKBP II - Download laporan</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li class="treeview">
        ...
        <li class="active">
          <a href="<?php echo base_url().'pendeta/downloadlaporan'?>">
        ...
        <li>
         ...
         <li>
          <a href="<?php echo base_url().'pendeta/login'?>">
          ...
          <div class="box">
           ...
           <div class="box">
            ...
            <label class="label-control"><h4>Filter Berdasarkan : </h4></label>    
               <a class="btn btn-flat" href="<?php echo base_url().'pendeta/ama'?>" style="background-color: darkcyan; color: white">Ama</a>
               <a class="btn btn-success btn-flat" href="<?php echo base_url().'pendeta/ina'?>" style="background-color: darkcyan; color: white">Ina</a>
               <a class="btn btn-success btn-flat" href="<?php echo base_url().'pendeta/naposo'?>" style="background-color: darkcyan; color: white">Naposo</a>
               <a class="btn btn-success btn-flat" href="<?php echo base_url().'pendeta/remaja'?>" style="background-color: darkcyan; color: white">Remaja</a>
               <a class="btn btn-success btn-flat" href="<?php echo base_url().'pendeta/skm'?>" style="background-color: darkcyan; color: white">Sekolah Minggu</a>
             </div>
             <!--- END//BUTTON KATEGORI---->
           <!-- /.box-header -->
            <div class="box-body">
