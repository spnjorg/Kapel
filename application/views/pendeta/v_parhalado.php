...
<head>
  ...
  <title>HKBP II - Data Parhalado</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <li class="treeview">
         ...
         <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'pendeta/parhalado'?>"><i class="fa fa-spinner fa-pulse"></i>Parhalado</a></li>
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'pendeta/jadwalibadah'?>"><i class="fa fa-list"></i> Jadwal Ibadah</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <ul class="pull-right"><a href="<?php echo base_url('admin/laporan/laporan_parhalado');?>" class="btn btn-flat" style="background-color: darkcyan; color: white;"><span class="glyphicon glyphicon-save fa fa-print"></span> PRINT </a>
               </ul> 
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tbody>
          				<?php
          					...
          					foreach ($data->result_array() as $i) :
          					   $no++;
          					   $id=$i['parhalado_id'];
          					   $nama=$i['parhalado_nama'];
          					   $tmp_lahir=$i['parhalado_tmp_lahir'];
                       $tgl_lahir=$i['parhalado_tgl_lahir'];
          					   $jenkel=$i['parhalado_jkel'];
                       $jabatan=$i['parhalado_jabatan'];
                       $nohp=$i['parhalado_nohp'];
                       $alamat=$i['parhalado_alamat'];
          					   $lingkungan_id=$i['parhalado_lingk_id'];
                       $lingkungan_nama=$i['lingkungan_nama'];
                       $pendidikan=$i['parhalado_pend'];
                       $pekerjaan=$i['parhalado_pekerjaan'];
                       $dilantik=$i['parhalado_dilantik'];
                       $photo=$i['parhalado_photo'];
                ...
                <tr>
                  ...
                  <td><?php echo $lingkungan_nama;?></td>

                  <td><?php echo $pendidikan;?></td>
                  <td><?php echo $pekerjaan;?></td>
                  <td><?php echo $dilantik;?></td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Add Parhalado</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'pendeta/parhalado/simpan_parhalado'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Dilantik</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xdilantik" class="form-control" id="inputUserName" placeholder="Dilantik" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Parhalado</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'pendeta/parhalado/update_parhalado'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Jabatan</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xjabatan" value="<?php echo $jabatan;?>" class="form-control" id="inputUserName" placeholder="Dilantik" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Pendidikan</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xpendidikan" value="<?php echo $pendidikan;?>" class="form-control" id="inputUserName" placeholder="Pendidikan" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Dilantik</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xdilantik" value="<?php echo $dilantik;?>" class="form-control" id="inputUserName" placeholder="Dilantik" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus Parhalado</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'pendeta/parhalado/hapus_parhalado'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							       <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                     <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                            <p>Apakah Anda yakin mau menghapus Data Parhalado <b><?php echo $nama;?></b> ?</p>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Data Parhalado Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Data Parhalado berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Data Parhalado Berhasil dihapus.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
