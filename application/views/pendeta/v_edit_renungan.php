      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'pendeta/renungan/add_renungan'?>"><i class="fa fa-star-o fa-pulse"></i> Post Renungan</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        $b=$data->row_array();
    ?>
		<form action="<?php echo base_url().'pendeta/renungan/update_renungan'?>" method="post" enctype="multipart/form-data">
