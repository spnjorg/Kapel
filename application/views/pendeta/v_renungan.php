      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'pendeta/renungan'?>"><i class="fa fa-star-o fa-pulse"></i> List Renungan</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'pendeta/renungan/add_renungan'?>"><span class="fa fa-plus"></span> Post Renungan</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  ...
                  <td style="text-align:right;">
                        <a class="btn" href="<?php echo base_url().'pendeta/renungan/get_edit/'.$renungan_id;?>"><span class="fa fa-pencil"></span></a>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $renungan_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'pendeta/renungan/hapus_renungan'?>" method="post" enctype="multipart/form-data">
