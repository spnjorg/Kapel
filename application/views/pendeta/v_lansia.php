        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <label class="label-control"><h4>Filter Berdasarkan : </h4></label>
               <ul class="pull-right"><a href="<?php echo base_url('pendeta/laporan/laporan_lansia');?>" class="btn btn-primary" style="background-color: ; color: white;"><span class="glyphicon glyphicon-save fa fa-print"></span> Print </a>
               </ul>   
               ...
               <a class="btn btn-flat" href="<?php echo base_url().'pendeta/laporan/lansia'?>" style="background-color: lightcyan; color: black;">Lansia</a>
             </div>
