        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <label class="label-control"><h4>Filter Berdasarkan : </h4></label>
               <ul class="pull-right"><a href="<?php echo base_url('pendeta/laporan/laporan_remaja');?>" class="btn btn-primary" style="background-color: ; color: white;"><span class="glyphicon glyphicon-save fa fa-print"></span> Print </a>
               </ul>   
               ...
               <a class="btn btn-flat" href="<?php echo base_url().'pendeta/laporan/remaja'?>" style="background-color: lightcyan; color: black;">Remaja</a>
               <a class="btn btn-success btn-flat" href="<?php echo base_url().'pendeta/laporan/skm'?>" style="background-color: darkcyan; color: white">Sekolah Minggu</a>
