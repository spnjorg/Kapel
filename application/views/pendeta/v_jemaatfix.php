      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
         ...
         <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'pendeta/jemaat'?>"><i class="fa fa-star-o fa-pulse"></i>Jemaat</a></li>
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal" style="background-color: darkcyan; color: white; margin-top: 20px; "><span class="fa fa-plus"></span> Tambah Data</a>
                  ...
                  <ul class="pull-right">
                        <a class="btn btn-success btn-flat" href="<?php echo base_url().'pendeta/laporan/laporan_alljemaat'?>" style="background-color: darkcyan; color: white; margin-top: 20px; "><span class="fa fa-print"></span> Print All</a>
                    </ul>
       ...
       <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'pendeta/jemaat/simpan_jemaat'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nomor ID</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xid" class="form-control" id="inputUserName" placeholder="Contoh : D6R150001" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnokk" class="form-control" id="inputUserName" placeholder="Contoh : KK010001" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'pendeta/jemaat/update_jemaat'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                ...
                                <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nomor ID</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xid" value="<?php echo $id;?>" class="form-control" id="inputUserName" placeholder="Contoh : D6R150001" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nomor KK</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnokk"  value="<?php echo $nokk;?>" class="form-control" id="inputUserName" placeholder="Contoh : KK010001" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'pendeta/jemaat/hapus_jemaat'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
