...
<head>
  ...
  <title>HKBP II - Laporan AMA</title>
       ...
       <li class="treeview">
        ...
        <li class="active">
          <a href="<?php echo base_url().'pendeta/ama'?>">
            <i class="fa fa-sta fa-pulse"></i> <span> Hasil & Laporan</span>
            <span class="pull-right-container">
              <small class="label pull-right"></small>
            </span>
          </a>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <label class="label-control"><h4>Filter Berdasarkan : </h4></label>
               <ul class="pull-right"><a href="<?php echo base_url('pendeta/laporan/laporan_ama');?>" class="btn btn-flat" style="background-color: darkcyan; color: white;"><span class="glyphicon glyphicon-save fa fa-print"></span> PRINT </a>
               </ul>   

               <a class="btn btn-flat" href="<?php echo base_url().'pendeta/ama'?>" style="background-color: lightcyan; color: black">Ama</a>
               ...
               <a class="btn btn-success btn-flat" href="<?php echo base_url().'pendeta/lansia'?>" style="background-color: darkcyan; color: white">Lansia</a>
             </div>
           <!-- /.box-header -->
            <div class="box-body">
