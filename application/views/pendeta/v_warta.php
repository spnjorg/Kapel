      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
       ...
       <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'pendeta/warta'?>"><i class="fa fa-star-o fa-pulse"></i> List Warta</a></li>
          ...
          <div class="box">
            <div class="box-header">
              ...
              <!-- Bagian Select by Tanggal--> 
               <!-- <form class="form-horizontal" action="<?php echo base_url().'admin/warta/filtertgl_warta'?>" method="post" enctype="multipart/form-data"> 
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-6" style="margin-top:-15px;">
                    ...
                    <input class="form-control" type="date" name="xtglakhir" placeholder="Tanggal Akhir"requiredd> 
                        ...
                        <ul>
                        <button type="submit" class="btn btn-flat" id="simpan" style="background-color: darkcyan; color: white; margin-top: 5px; "> <span class="glyphicon glyphicon-save fa fa-filter"></span> Filter</button>
                        </ul>
                  </form> -->
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'pendeta/warta/hapus_wartain'?>" method="post" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="ModalAddkat<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'pendeta/wartafix/simpan_walist'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
