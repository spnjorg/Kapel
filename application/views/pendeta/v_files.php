...
<head>
  ...
  <title>HKBP II - Download Warta</title>
...
<div class="wrapper">
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
       ...
       <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'pendeta/files'?>"><i class="fa fa-spinner fa-pulse"></i> Download</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Download Warta</li>
      </ol>
    </section>
          ...
          $no=0;
            foreach ($data->result_array() as $i) :
               $no++;
                ...
                <tr>
                  <td><?php echo $no;?></td>
                  <td><a href="<?php echo base_url().'pendeta/files/download/'.$id;?>"><?php echo $judul;?></a></td>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="http://spnjorg.com">Steffanny Putri</a>.</strong> All rights reserved.
  </footer>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'pendeta/files/simpan_file'?>" method="post" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'pendeta/files/update_file'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'pendeta/files/hapus_file'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                           <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                           <input type="hidden" name="file" value="<?php echo $file;?>">
