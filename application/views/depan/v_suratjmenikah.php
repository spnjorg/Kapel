...
<head>
    ...
    <title>HKBP II - SP Jemaat Yang Hendak Menikah</title>
    ...
    <div class="container">
        <div class="row">
         ...
         <div class="form-group col-md-20">
            <form action="<?php echo site_url('surat/cek_suratjmenikah');?>" method="post">
                ...
                <table class="table table-striped" id="display">
                  <thead>
                    <tr>
                      ...
                      <th style="text-align:center;">Nama Calon Yang Hendak Menikah</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;"><?php echo $row->sk_nama.' / '.$row->sk_namapasangan;?></td>
                
                      <?php if($row->sk_status==1):?>
                      <td style="text-align:center;"> Selesai <a href="<?php echo site_url('surat/get_suratjmenikah/'.$row->sk_id);?>" class="btn btn-info pull-right">Download</a></td>
                      <?php else:?>
         ...
         <div class="row">
            <div class="col-md-12">
                <div class="contact-title" style="margin-top:50px;">
                    <h3 style="text-align:center;"><b>Surat Pengantar Jemaat Hendak Menikah</b></h3>
                </div>
            </div>
        </div>
                ...
                <div class="contact-form">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 contact-option">
                            <form action="<?php echo site_url('admin/surat/simpan_smenikah');?>" method="post">
                            <div class="contact-option_rsp">
                                <h3>Surat Hatorangan Sian Sintua Lingkungan </h3>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="control-label" style="color: dimgray;">Goar/Marga <span class="text-danger">*</span> </label>
                                        <input type="text" class="form-control" placeholder="Nama Jemaat Yang Hendak Menikah" name="xnama" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="" class="control-label" style="color: dimgray;">Goar Nioroan/Pangoli <span class="text-danger">*</span> </label>
                                        <input type="text" class="form-control" placeholder="Name Pasangan Yang Hendak dinikahi" name="xnamapasangan" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="control-label" style="color: dimgray;">Huria <span class="text-danger">*</span> </label>
                                        <input type="text" class="form-control" placeholder="Nama Huria" name="xhuria" required>
                                    </div>
                         ...
                         <div class="col-xs-12 col-sm-6 col-md-6 contact-option">
                            <div class="contact-option_rsp">
                                <h3><br></h3>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="control-label" style="color: dimgray;">Ket. Jenis Kelamin <span class="text-danger">*</span> </label>
                                        <select class="form-control" name="xjenkel" requiredd>
                                            <option value=" ">-- Pilih--</option>
                                            <option value="L">Anak</option>
                                            <option value="P">Boru</option>
                                        </select>
                                    </div>  
                                    ...
                                    <div class="form-group">
                                        <label for="" class="control-label" style="color: dimgray;"> Tanggal Baptis<span class="text-danger">*</span> </label>
                                        <input class="form-control" type="date" name="xtglbaptis" placeholder="Tanggal Baptis" requiredd> 
                                    </div>

                                    <div class="form-group">
                                        <label for="" class="control-label" style="color: dimgray;"> Tanggal Sidi<span class="text-danger">*</span> </label>
                                        <input class="form-control" type="date" name="xtglsidi" placeholder="Tanggal Sidi" requiredd> 
                                    </div>

                                    <div class="form-group">
                                        <label for="" class="control-label" style="color: dimgray;"> Tgl. Pemberkatan Pernikahan<span class="text-danger">*</span> </label>
                                        <input class="form-control" type="date" name="xtglnikah" placeholder="Tanggal Pemberkatan Pernikahan" requiredd> 
                                    </div>
