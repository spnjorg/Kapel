                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 contact-option">
                            <div class="contact-option_rsp">
                                ...
                                <form action="<?php echo site_url('user/kirim_pesan');?>" method="post">
                                <?php
                                ...
                                ?>
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="<?php echo $c['pengguna_nama'];?>" placeholder="Name" name="xnama" required>
                                    </div>
                                    <!-- // end .form-group -->
                                    <div class="form-group">
                                        <input type="email" class="form-control" value="<?php echo $c['pengguna_email'];?>" placeholder="Email" name="xemail" required>
                                    </div>
                                    <!-- // end .form-group -->
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="<?php echo $c['jemaat_notelp'];?>" placeholder="Phone" name="xphone" required>
                                    </div>
                                    <!-- // end .form-group -->
                                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="contact-address">
                                ...
                                <div class="contact-details">
                                    ...
                                    <h6>Alamat</h6>
                                    <p> Jl. Damai No. 51 Sidikalang - Kab.DAIRI</p>
                                    </div>
                                    <br>
                                    <div class="contact-details">
                                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                                        <h6>Email</h6>
                                        <p> hkbpsdk2@gmail.com
                                        </p>
                                    </div>
                                    <br>
                                    <div class="contact-details">
