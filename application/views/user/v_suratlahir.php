                                ...
                                <h3><br></h3>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="xlingkungan" requiredd>
                                             <option value="<?php echo $c['kk_lingk_id'];?>">--Pilih--</option>
                                            <?php
...
<?php
  ...
  ?>
    ...
    <?php if($this->session->flashdata('msg')=='success'):?>
        echo "<script> 
      alert('TERIMA KASIH! PERMINTAAN SURAT KETERANGAN ANDA TELAH MASUK KE SERVER KAMI. DAN AKAN SEGERA DI PROSES. INFORMASI SELANJUTNYA BISA ANDA LIHAT PADA CEK SURAT KETERANGAN MENGGUNAKAN USERNAME ANDA!');
        </script> ";
