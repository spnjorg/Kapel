...
<head>
    ...
    <title>HKBP II - SP Marguru SIDI</title>
    ...
    <div class="container">
        <div class="row">
         ...
         <div class="form-group col-md-20">
            <form action="<?php echo site_url('surat/cek_suratsidi');?>" method="post">
                ...
                <table class="table table-striped" id="display">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;"> Selesai <a href="<?php echo site_url('surat/get_suratsidi/'.$row->surat_id);?>" class="btn btn-info pull-right">Download</a></td>
                      <?php else:?>
         ...
         <div class="row">
            <div class="col-md-12">
                <div class="contact-title" style="margin-top:50px;">
                    <h3 style="text-align:center;"><b>Surat Pengantar Marguru Manghatindangkon Haporseaon</b></h3>
                </div>
            </div>
        </div>
                ...
                <div class="contact-form">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 contact-option">
                            <form action="<?php echo site_url('admin/surat/simpan_ssidi');?>" method="post">
                            <div class="contact-option_rsp">
                                ...
                                ?>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="control-label" style="color: dimgray;">Nama Lengkap <span class="text-danger">*</span> </label>
                                        <input type="text" class="form-control" value="<?php echo $c['jemaat_nama'];?>" placeholder="Nama Lengkap" name="xnama" required>
                                    </div>
                         ...
                         <div class="col-xs-12 col-sm-6 col-md-6 contact-option">
                            <div class="contact-option_rsp">
                                <h3><br></h3>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="control-label" style="color: dimgray;">Tanggal Tardidi <span class="text-danger">*</span> </label>
                                        <input class="form-control" type="date" name="xtgltardidi" placeholder="Tanggal Tardidi"requiredd> 
                                    </div>
