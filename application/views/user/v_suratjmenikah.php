                ...
                <table class="table table-striped" id="display">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;"><?php echo $row->jemaat_nama.'/'.$row->sk_namapasangan;?></td>
                            ...
                            <div class="contact-option_rsp">
                                ...
                                ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $c['jemaat_id'];?>" placeholder="Masukkan ID Keluarga Anda" name="xidjemaat" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="" class="control-label" style="color: dimgray;">Goar/Marga <span class="text-danger">*</span> </label>
                                        <input type="text" class="form-control" value="<?php echo $c['jemaat_nama'];?>" placeholder="Nama Jemaat Yang Hendak Menikah" name="xnama" required>
                                    </div>
