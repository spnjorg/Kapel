...
<head>
    ...
    <title>HKBP II - <?php echo $title;?></title>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="blog-tiltle_block">
                    <h4><a href="<?php echo site_url('user_artikel/'.$slug);?>"><?php echo $title;?></a></h4>
                    ...
                    <div class="blogpost-tabs">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="write-comment" role="tabpanel">
                                <form action="<?php echo site_url('user/komentar');?>" method="post">
                                <?php
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label>Nama</label>
                                                <input type="text" class="form-control" name="nama" value="<?php echo $c['pengguna_nama'];?>" placeholder="Nama Lengkap" required>
                                            </div>
                                            <!-- // end .form-group -->
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="email" class="form-control" name="email" value="<?php echo $c['pengguna_email'];?>" placeholder="Email" required>
                                            </div>
                                            <!-- // end .form-group -->
                                        </div>
                                        <div class="col-12">
