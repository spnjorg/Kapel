...
<head>
  ...
  <title>HKBP II - Surat Pengantar SIDI</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Surat Pengantar : Marguru Manghatindangkon Haporseaon
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Surat Pengantar</li>
        <li class="active">Sidi</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <label class="label-control"><h4>Surat Pengantar : </h4></label>
               <ul class="pull-right">
                ...
                <a href="<?php echo base_url('admin/laporan/laporan_');?>" class="btn btn-flat" style="background-color: darkcyan; color: white; margin-top: 5px;"><span class="glyphicon glyphicon-save fa fa-print"></span> PRINT </a> -->
               </ul>   
               ...
               <a class="btn btn-flat" href="<?php echo base_url().'admin/surat/sidi'?>" style="background-color: lightcyan; color: black;">Sidi</a>
                ...
                <tbody>
                  <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       ...
                       $tanggal_tardidi=$i['surat_tgltardidi'];
                       $tanggal_new= date('d F Y', strtotime($tanggal));
                       $tgltardidi_new= date('d F Y', strtotime($tanggal_tardidi));
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/surat/simpan_sksidi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="date" name="xtgltardidi" class="form-control" id="inputUserName" placeholder="Contoh: Tahun-bulan-hari (2000-01-01)" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Surat Pengantar : Marguru Sidi</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/surat/update_sksidi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tanggal Tardidi</label>
                                        <div class="col-sm-7">
                                            <input type="date" name="xtgltardidi" value="<?php echo $tanggal_tardidi;?>" class="form-control" id="inputUserName" placeholder="Contoh: Tahun-bulan-hari (2000-01-01)" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus Surat Pengantar : Sidi</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/surat/hapus_sksidi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                            <p>Apakah Anda yakin mau menghapus data Surat Sidi dari  <b><?php echo $nama;?></b> ?</p>
        ...
        <div class="modal fade" id="ModalAddsk<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Tambah Data Ke Halaman Sidi</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/sidi/simpan_sksidi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="date" name="xtanggal" class="form-control" id="inputUserName" placeholder="Masukkan Tanggal" required>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Hamuliateon</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xham" class="form-control" id="inputUserName" placeholder="Contoh : 300,000" required>
                                        </div>
                                    </div>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "SK Marguru SIDI Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='berhasil'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Data SIDI Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "SK Marguru SIDI berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "SK Marguru SIDI Berhasil dihapus.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
