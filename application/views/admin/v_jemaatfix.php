        ...
        <li class="treeview">
         ...
         <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'admin/jemaat'?>"><i class="fa fa-star-o fa-pulse"></i>Data Jemaat</a></li>
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal" style="background-color: darkcyan; color: white; margin-top: 20px; "><span class="fa fa-plus"></span> Tambah Data</a>
                  ...
                  <ul class="pull-right">
                        <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/laporan/laporan_alljemaat'?>" style="background-color: darkcyan; color: white; margin-top: 20px; "><span class="fa fa-print"></span> Print All</a>
                    </ul>
