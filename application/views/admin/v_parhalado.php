        ...
        <li class="treeview">
         ...
         <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'admin/parhalado'?>"><i class="fa fa-star-o fa-pulse"></i>Parhalado</a></li>
                ...
                <tbody>
          				<?php
          					...
          					foreach ($data->result_array() as $i) :
          					   ...
          					   $id=$i['parhalado_id'];
          					   $nama=$i['jemaat_nama'];
          					   $tmp_lahir=$i['jemaat_tmptlahir'];
                       $tgl_lahir=$i['jemaat_tgllahir'];
          					   $jenkel=$i['jemaat_jenkel'];
                       $jabatan=$i['parhalado_jabatan'];
                       $nohp=$i['jemaat_notelp'];
                       $alamat=$i['kk_alamat'];
...
<!-- ./wrapper -->
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/parhalado/simpan_parhalado'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="date" name="xdilantik" class="form-control" id="inputUserName" placeholder="Dilantik" required>
                                        </div>
                                    </div>
  ...
  <?php foreach ($data->result_array() as $i) :
                       $id=$i['parhalado_id'];
                       $jemaat_id=$i['parhalado_jemaat_id'];
                       $nama=$i['jemaat_nama'];
                       $tmp_lahir=$i['jemaat_tmptlahir'];
                       $tgl_lahir=$i['jemaat_tgllahir'];
                       $jenkel=$i['jemaat_jenkel'];
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/parhalado/update_parhalado'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Dilantik</label>
                                        <div class="col-sm-7">
                                            <input type="date" name="xdilantik" value="<?php echo $dilantik;?>" class="form-control" id="inputUserName" placeholder="Dilantik" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/parhalado/hapus_parhalado'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							       <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                     <input type="hidden" value="<?php echo $photo;?>" name="gambar">
