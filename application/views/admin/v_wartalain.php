        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <label class="label-control"><h4>Kategori Warta : </h4></label>
               ...
               <a class="btn btn-flat" href="<?php echo base_url().'admin/wartafix/wartalain'?>" style="background-color:lightcyan; color: black;">Lainnya</a> 
             </div>
           <!-- /.box-header -->
            <div class="box-body">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/wartafix/simpan_wartafix_wartalain'?>" method="post" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/wartafix/update_wartafix_wartalain'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/wartafix/hapus_wartafix_wartalain'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
