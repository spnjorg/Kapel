...
<head>
  ...
  <title>HKBP II - Jadwal Petugas Ibadah [SKM]</title>
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'admin/jadwalpetugas'?>"><i class="fa fa-star-o fa-pulse"></i> Jadwal Petugas</a></li>
          </ul>
        </li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <label class="label-control"><h4>Petugas Ibadah : </h4></label>
               ...
               <a class="btn btn-flat" href="<?php echo base_url().'admin/jadwalpetugas'?>" style="background-color: darkcyan; color: white;"> Minggu Umum</a>
               <a class="btn  btn-flat" href="<?php echo base_url().'admin/jadwalpetugas/skm'?>" style="background-color: lightcyan; color: black;"> Sekolah Minggu</a>
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:12px;">
                ...
                <tr>
                    ...
                    <th style="text-align:center">Liturgis/Agenda</th>
                    <th style="text-align:center">Khotbah/Kidung nyanyian</th>
                    <th style="text-align:center">Piket/Pengawas</th>
                    <th style="text-align:center">Organis</th>
                ...
                <tbody>
                  <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       $no++;
                       $petugas=$i['petugas_skmid'];
                       $tanggal=$i['petugas_skmtgl'];
                       $tanggal_new= date('d F Y', strtotime($tanggal));
                       $musik=$i['petugas_skmmusik'];
                       $skmliturgis=$i['petugas_skmliturgis'];
                       $skmkhotbah=$i['petugas_skmkhotbah'];
                       $skmpiket=$i['petugas_skmpiket'];
                       $skmket=$i['petugas_skmket'];
                ...
                <tr>
                  ...
                  <td style="text-align:center"><?php echo $skmliturgis;?></td>
                  <td style="text-align:center"><?php echo $skmkhotbah;?></td>
                  <td style="text-align:center"><?php echo $skmpiket;?></td>
                  <td style="text-align:center"><?php echo $musik;?></td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Add Petugas Sekolah Minggu</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/jadwalpetugas/simpan_petugasskm'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                  <input type="text" name="xjamita" class="form-control" id="inputUserName" placeholder="Nama Pengkhotbah" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                  <input type="text" name="xagenda" class="form-control" id="inputUserName" placeholder="Nama Petugas Agenda" required>
                                </div>
                            </div>

                             <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Piket/Pengawas</label>
                                <div class="col-sm-7">
                                  <input type="text" name="xpiket" class="form-control" id="inputUserName" placeholder="Piket/Pengawas" required>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $petugas;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Petugas Sekolah Minggu</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/jadwalpetugas/update_petugasskm'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="kode" value="<?php echo $petugas;?>"/>
                           ...
                           <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Jamita/Khotbah</label>
                                <div class="col-sm-7">
                                  <input type="text" name="xjamita" value="<?php echo $skmkhotbah;?>"class="form-control" id="inputUserName" placeholder="Nama Pengkhotbah" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Agenda/Liturgis</label>
                                <div class="col-sm-7">
                                  <input type="text" name="xagenda" value="<?php echo $skmliturgis;?>" class="form-control" id="inputUserName" placeholder="Nama Petugas Agenda" required>
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Piket/Pengawas</label>
                                <div class="col-sm-7">
                                  <input type="text" name="xpiket" value="<?php echo $skmpiket;?>" class="form-control" id="inputUserName" placeholder="Piket/Pengawas" required>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $petugas;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/jadwalpetugas/hapus_petugasskm'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
              <input type="hidden" name="kode" value="<?php echo $petugas;?>"/>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Jadwal Petugas Sekolah Minggu Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Jadwal Petugas Sekolah Minggu berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Jadwal Petugas Sekolah Minggu Berhasil dihapus.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
