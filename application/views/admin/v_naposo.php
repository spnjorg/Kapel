      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="<?php echo base_url().'admin/surat'?>">
            <i class="fa fa-pencil"></i> <span>Surat Pertanyaan</span>
            <span class="pull-right-container">
              <small class="label pull-right"></small>
            </span>
          </a>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <label class="label-control"><h4>Filter Berdasarkan : </h4></label>
               <ul class="pull-right"><a href="<?php echo base_url('admin/laporan/laporan_naposo');?>" class="btn btn-primary" style="background-color: ; color: white;"><span class="glyphicon glyphicon-save fa fa-print"></span> Print </a>
               </ul>   
               ...
               <a class="btn btn-flat" href="<?php echo base_url().'admin/laporan/naposo'?>" style="background-color: lightcyan; color: black;">Naposo</a>
               ...
               <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/laporan/skm'?>" style="background-color: darkcyan; color: white">Sekolah Minggu</a>
