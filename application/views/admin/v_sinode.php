        ...
        <li class="treeview">
         ...
         <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'admin/jemaat/sinode'?>"><i class="fa fa-spinner fa-pulse"></i>Data Jemaat</a></li>
            <li><a href="<?php echo base_url().'admin/parhalado'?>"><i class="fa fa-book"></i>Parhalado</a></li></a></li>
          </ul>
        </li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <form class="form-horizontal" action="<?php echo base_url().'admin/laporan/laporan_sinode'?>" method="post" enctype="multipart/form-data"> 
                  <div class="col-xs-6" style="margin-top:;">
                    <span style="font-size: xx-small;">Filter berdasarkan Lingkungan :</span>
                  ...
                  <button type="submit" class="btn btn-flat" id="simpan" style="background-color: darkcyan; color: white; margin-top: 20px; "> <span class="glyphicon glyphicon-save fa fa-print"></span> Cetak Laporan</button>

                     <ul class="pull-right">
                        <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal" style="background-color: darkcyan; color: white; margin-top: 20px; "><span class="fa fa-plus"></span> Tambah Data</a>
                        <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/laporan/laporan_allsinode'?>" style="background-color: darkcyan; color: white; margin-top: 20px; "><span class="fa fa-print"></span> Print All</a>
              ...
              <table id="example1" class="table table-striped" style="font-size:13px;">
               ...
               <tr>
                ...
                <tbody>
                  <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       ...
                       $nokk=$i['sinode_no_kk'];
                       $nama=$i['sinode_nama'];
                       $jenkel=$i['sinode_jenkel'];
                       $tmptlahir=$i['sinode_tmptlahir'];
                       $tgllahir=$i['sinode_tgllahir'];
                       $lahir_new= date('d F Y', strtotime($tgllahir));
                       $tgltardidi=$i['sinode_tgltardidi'];
                       $tardidi_new= date('d F Y', strtotime($tgltardidi));
                       $tglmalua=$i['sinode_tglmalua'];
                       $malua_new= date('d F Y', strtotime($tglmalua));
                       $pendidikan=$i['sinode_pendidikan'];
                       $pekerjaan=$i['sinode_pekerjaan'];
                       $status=$i['sinode_statuskel'];
                       $notelp=$i['sinode_notelp'];
                       $nourutkk=$i['sinode_nourutkk'];
                       $lingkungan_id=$i['sinode_lingk_id'];
                       $lingkungan_nama=$i['lingkungan_nama'];
                       $alamat=$i['sinode_alamat'];
                       $flag_id=$i['sinode_flag_id'];
                ...
                <tr>
                  <td><?php echo $no;?></td>
                  <td><?php echo $nama;?></td>
                  <td><?php echo $tmptlahir.', '.$lahir_new;?></td>
                  ...
                  <td><?php echo $tardidi_new;?></td>
                  <td><?php echo $malua_new;?></td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Add Data Jemaat</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/jemaat/simpan_sinode'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nomor ID</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xid" class="form-control" id="inputUserName" placeholder="Contoh : D10200010001" required>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nomor KK</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnokk" class="form-control" id="inputUserName" placeholder="Nomor Kartu Keluarga" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xtmptlahir" class="form-control" id="inputUserName" placeholder="Tempat Lahir">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="date" name="xtgllahir" class="form-control" id="inputUserName" placeholder="Contoh: Tahun-bulan-hari (2000-01-01)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="date" name="xtgltardidi" class="form-control" id="inputUserName" placeholder="Contoh: Tahun-bulan-hari (2000-01-01)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="date" name="xtglmalua" class="form-control" id="inputUserName" placeholder="Contoh: Tahun-bulan-hari (2000-01-01)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xpendidikan" class="form-control" id="inputUserName" placeholder="Pendidikan">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xpekerjaan" class="form-control" id="inputUserName" placeholder="Pekerjaan">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnotelp" class="form-control" id="inputUserName" placeholder="No. Telepon">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Keterangan Status</label>
                                        <div class="col-sm-7">
                                          <select name="xflag" class="form-control" required>
                                            <option value="">-Pilih-</option>
                                            <?php
                                                foreach ($flag->result_array() as $k) {
                                                  $id=$k['flag_id'];
                                                  $nama=$k['flag_nama'];
                                            ?>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Data Jemaat</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/jemaat/update_sinode'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                ...
                                <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nomor ID</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xid" value="<?php echo $id;?>" class="form-control" id="inputUserName" placeholder="Contoh : D10200010001" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nomor KK</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnokk"  value="<?php echo $nokk;?>" class="form-control" id="inputUserName" placeholder="Nomor Kartu Keluarga" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tempat Lahir</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xtmptlahir" value="<?php echo $tmptlahir;?>" class="form-control" id="inputUserName" placeholder="Tempat Lahir">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tanggal Lahir</label>
                                        <div class="col-sm-7">
                                            <input type="date" name="xtgllahir" value="<?php echo $tgllahir;?>" class="form-control" id="inputUserName" placeholder="Contoh: Tahun-bulan-hari (2000-01-01)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tanggal Tardidi</label>
                                        <div class="col-sm-7">
                                            <input type="date" name="xtgltardidi" value="<?php echo $tgltardidi;?>" class="form-control" id="inputUserName" placeholder="Contoh: Tahun-bulan-hari (2000-01-01)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tanggal Malua</label>
                                        <div class="col-sm-7">
                                            <input type="date" name="xtglmalua" value="<?php echo $tglmalua;?>" class="form-control" id="inputUserName" placeholder="Contoh: Tahun-bulan-hari (2000-01-01)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Pendidikan</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xpendidikan" value="<?php echo $pendidikan;?>" class="form-control" id="inputUserName" placeholder="Pendidikan">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Pekerjaan</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xpekerjaan" value="<?php echo $pekerjaan;?>" class="form-control" id="inputUserName" placeholder="Pekerjaan">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                          ...
                                          <?php elseif($status=='Ibu Rumah Tangga'):?>
                                            <div class="radio radio-info radio-inline">
                                            ...
                                            <?php elseif($status=='Kepala Keluarga/Ibu Rumah Tangga'):?>
                                            <div class="radio radio-info radio-inline">
                                                <input type="radio" id="inlineRadio1" value="Kepala Keluarga" name="xstatuskk">
                                                <label for="inlineRadio1"> Kepala Keluarga </label>
                                            </div>
                                     ...
                                     <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">No.Telepon</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnotelp" value="<?php echo $notelp;?>" class="form-control" id="inputUserName" placeholder="No. Telepon">
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/jemaat/hapus_sinode'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                     <p>Apakah Anda yakin mau menghapus Data dari <b><?php echo $nama;?></b> ?</p>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Data Jemaat Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Data Jemaat berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
