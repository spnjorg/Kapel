...
<head>
  ...
  <title>HKBP II - Data Pengguna</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
         ...
         <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'admin/pengguna'?>"><i class="fa fa-star-o fa-pulse"></i> User</a></li>
...
<!--Modal Add Pengguna-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <select class="form-control" name="xlevel" required>
                                                ...
                                                <option value="3">Parhalado</option>
                                                <option value="4">Jemaat</option>
                                            </select>
                                        </div>
                                    </div>
		...
		<?php foreach ($data->result_array() as $i) :
              $pengguna_id=$i['pengguna_id'];
                       $pengguna_jemaat_id=$i['pengguna_jemaat_id'];
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <input type="hidden" name="kode" value="<?php echo $pengguna_id;?>"/>
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">ID Jemaat</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xidjemaat" class="form-control" value="<?php echo $pengguna_jemaat_id;?>" id="inputUserName" placeholder="ID Jemaat" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnama" class="form-control" value="<?php echo $pengguna_nama;?>" id="inputUserName" placeholder="Email" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-7">
                                            <select class="form-control" name="xlevel" required>
                                                ...
                                                <option value="4">Jemaat</option>
										                      	...
										                      	<?php elseif($pengguna_level=='2'):?>
												                        <option value="1">Administrator</option>
                                                <option value="2" selected>Pendeta</option>
                                                <option value="3">Parhalado</option>
                                                <option value="4">Jemaat</option>
                                            ...
                                            <?php elseif($pengguna_level=='3'):?>
                                                <option value="1">Administrator</option>
                                                <option value="2">Pendeta</option>
                                                <option value="3" selected>Parhalado</option>
                                                <option value="4">Jemaat</option>
                                           ...
                                           <?php else:?>
                                                ...
                                                <option value="2">Pendeta</option>
                                                <option value="3">Parhalado</option>
                                                <option value="4" selected>Jemaat</option>
