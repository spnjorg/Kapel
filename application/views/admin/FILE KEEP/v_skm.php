        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <label class="label-control"><h4>Filter Berdasarkan : </h4></label>
               <ul class="pull-right"><a href="<?php echo base_url('admin/laporan/laporan_skm');?>" class="btn btn-flat" style="background-color: darkcyan; color: white;"><span class="glyphicon glyphicon-save fa fa-print"></span> PRINT </a>
               </ul>      
               ...
               <a class="btn btn-flat" href="<?php echo base_url().'admin/skm'?>" style="background-color: lightcyan; color: black">Sekolah Minggu</a>
               <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/lansia'?>" style="background-color: darkcyan; color: white">Lansia</a>
