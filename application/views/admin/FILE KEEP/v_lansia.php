...
<head>
  ...
  <title>HKBP II - Laporan Lansia</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <label class="label-control"><h4>Filter Berdasarkan : </h4></label>
               <ul class="pull-right"><a href="<?php echo base_url('admin/laporan/laporan_lansia');?>" class="btn btn-flat" style="background-color: darkcyan; color: white;"><span class="glyphicon glyphicon-save fa fa-print"></span> PRINT </a>
               </ul>      
               <a class="btn btn-flat" href="<?php echo base_url().'admin/ama'?>" style="background-color: darkcyan; color: white">Ama</a>
               <a class="btn btn-flat" href="<?php echo base_url().'admin/ina'?>" style="background-color: darkcyan; color: white">Ina</a>
               <a class="btn btn-flat" href="<?php echo base_url().'admin/naposo'?>" style="background-color: darkcyan; color: white">Naposo</a>
               <a class="btn btn-flat" href="<?php echo base_url().'admin/remaja'?>" style="background-color: darkcyan; color: white">Remaja</a>
               <a class="btn btn-flat" href="<?php echo base_url().'admin/skm'?>" style="background-color: darkcyan; color: white;">Sekolah Minggu</a>
               <a class="btn btn-flat" href="<?php echo base_url().'admin/lansia'?>" style="background-color: lightcyan; color: black;">Lansia</a>
