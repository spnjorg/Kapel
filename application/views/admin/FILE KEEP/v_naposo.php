          ...
          <div class="box">
            <div class="box-header">
              ...
              <label class="label-control"><h4>Filter Berdasarkan : </h4></label>
               <ul class="pull-right"><a href="<?php echo base_url('admin/laporan/laporan_naposo');?>" class="btn btn-flat" style="background-color: darkcyan; color: white;"><span class="glyphicon glyphicon-save fa fa-print"></span> PRINT </a>
               </ul> 
               ...
               <a class="btn btn-flat" href="<?php echo base_url().'admin/naposo'?>" style="background-color: lightcyan; color: black">Naposo</a>
