...
<head>
  ...
  <title>HKBP II - Berita Kelahiran</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'admin/kelahiran'?>"><i class="fa fa-spinner fa-pulse"></i> Kelahiran</a></li>
                ...
                <tbody>
          				<?php
          					...
          					foreach ($data->result_array() as $i) :
          					   $no++;
                       $id=$i['kelahiran_id'];
                       $namaayah=$i['kelahiran_namaayah'];
          					   $namaibu=$i['kelahiran_namaibu'];
                       $tanggal=$i['kelahiran_tgl'];
                       $tanggal_new= date('d F Y', strtotime($tanggal));
                       $jenkel=$i['kelahiran_jenkel'];
                       $alamat=$i['kelahiran_alamat'];
                       $lingkungan_id=$i['kelahiran_id_lingk'];
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Tambah Data Kelahiran</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/kelahiran/simpan_kelahiran'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nama Ayah</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnamaayah" class="form-control" id="inputUserName" placeholder="Nama Lengkap Ayah" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nama Ibu</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnamaibu" class="form-control" id="inputUserName" placeholder="Nama Lengkap Ibu" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/kelahiran/update_kelahiran'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nama Ayah</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnamaayah" value="<?php echo $namaayah;?>" class="form-control" id="inputUserName" placeholder="Nama Lengkap Ayah" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nama Ibu</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnamaibu" value="<?php echo $namaibu;?>" class="form-control" id="inputUserName" placeholder="Nama Lengkap Ibu" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus Data Kelahiran</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/kelahiran/hapus_kelahiran'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                            <p>Apakah Anda yakin mau menghapus data kelahiran dari keluarga <b><?php echo $namaayah;?>/<?php echo $namaibu;?></b> ?</p>
