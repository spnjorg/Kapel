...
<head>
  ...
  <title>HKBP II - Data Pewarta</title>
        ...
        <li class="treeview">
         ...
         <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url().'admin/jemaat'?>"><i class="fa fa-user"></i>Data Jemaat</a></li>
            <li><a href="<?php echo base_url().'admin/parhalado'?>"><i class="fa fa-book"></i>Parhalado</a></li>
            <li class="active"><a href="<?php echo base_url().'admin/jemaat/pewarta'?>"><i class="fa fa-star-o fa-pulse"></i> Pewarta</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Pewarta</li>
      </ol>
    </section>
                ...
                <tbody>
                  <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       $no++;
                       $id=$i['pewarta_id'];
                       $jemaat_id=$i['pewarta_jemaat_id'];
                       $notelp=$i['pewarta_notelp'];
                       $nama=$i['pewarta_nama'];
                       $status_id=$i['pewarta_katfilter_id'];
                       $status_nama=$i['katfilter_nama'];
                    ?>

                <tr>
                  <td><?php echo $no;?></td>
                  <td><?php echo $jemaat_id;?></td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Add Data Pewarta</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/jemaat/simpan_pewarta'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnotelp" class="form-control" id="inputUserName" placeholder="Contoh : 6281234567890" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/jemaat/update_pewarta'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nomor Telepon</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnotelp" value="<?php echo $notelp;?>" class="form-control" id="inputUserName" placeholder="Contoh : 6281234567890" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus Data Pewarta</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/jemaat/hapus_pewarta'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                     <p>Apakah Anda yakin mau menghapus <b><?php echo $nama;?></b> Sebagai Pewarta ?</p>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Data Pewarta Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Data Pewarta berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Data Pewarta Berhasil dihapus.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
