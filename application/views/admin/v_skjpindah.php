...
<head>
  ...
  <title>HKBP II - Surat Pengantar Pindah Huria</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Surat Pengantar : Pindah Huria
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Surat Pengantar</li>
        <li class="active">Pindah Huria</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">            
               <div class="box-header">  
            <label class="label-control"><h4>Surat Keterangan : </h4></label>
               <ul class="pull-right">
               ...
               <a class="btn btn-flat" href="<?php echo base_url().'admin/surat/jpindah'?>" style="background-color: lightcyan; color: black;">Pindah </a>
               <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/surat/jmenikah'?>" style="background-color: darkcyan; color: white">Menikah</a>
             </div>
           <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                    ...
                    <th>Jlh. Anak</th>
                    <th>Lingkungan</th>
                    <th style="text-align:center;">Tu Huria</th>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/surat/simpan_skjpindah'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xidkeluarga" class="form-control" id="inputUserName" placeholder="Masukkan ID Keluarga" required>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Jumlah Anak</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xjlhanak" class="form-control" id="inputUserName" placeholder="Jumlah Anak" required>
                                        </div>
                                    </div>
                             
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tu Huria</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xtujuan" class="form-control" id="inputUserName" placeholder="Pindah ke Huria..." required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Surat Keterangan Pindah Huria</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/surat/update_skjpindah'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">ID Keluarga</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xidkeluarga" value="<?php echo $kk_id;?>" class="form-control" id="inputUserName" placeholder="Masukkan ID Keluarga" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Jumlah Anak</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xjlhanak" value="<?php echo $jlhanak;?>" class="form-control" id="inputUserName" placeholder="Jumlah Anak" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tu Huria</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xtujuan" value="<?php echo $tujuanhuria;?>" class="form-control" id="inputUserName" placeholder="Pindah ke Huria..." required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus Data Surat Pengantar : Pindah</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/surat/hapus_skjpindah'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                            <p>Apakah Anda yakin mau menghapus data Surat Pindahan dari keluarga <b><?php echo $nama;?></b> ?</p>
        ...
        <div class="modal fade" id="ModalAddsk<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Tambah Data Ke Halaman Jemaat Pindah Huria</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/jpindah/simpan_skjpindah'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                <input type="hidden" name="kode" value="<?php echo $id;?>"/>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "SK Pindahan Jemaat disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='berhasil'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Data Pindahan Jemaat Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "SK Pindahan Jemaat berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "SK Pindahan Jemaat Berhasil dihapus.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
