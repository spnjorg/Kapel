...
class Renungan extends CI_Controller{
	...
	function index(){
		...
		$this->load->view('pendeta/v_renungan',$x);
	}

	function add_renungan(){
		$x['kat']=$this->m_kategori->get_all_kategori();
		$this->load->view('pendeta/v_add_renungan',$x);
	}

	function video(){
		$x['video']=$this->m_kategori->get_all_video();
		$this->load->view('pendeta/v_video',$x);
	}
	...
	function get_edit(){
		...
		$x['kat']=$this->m_kategori->get_all_kategori();
		$this->load->view('pendeta/v_edit_renungan',$x);
	}
...
//VIDEO RENUNGAN_______________________________________________________________
	...
	function simpan_video(){
		...
		echo $this->session->set_flashdata('msg','success');
		redirect('pendeta/renungan/video');
