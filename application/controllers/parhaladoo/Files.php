...
class Files extends CI_Controller{
	...
	function index(){
		...
		$this->load->view('parhaladoo/v_files',$x);
	}
	...
	function simpan_file(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$this->m_files->simpan_file($judul,$deskripsi,$tanggal,$oleh,$file);
	...
	function update_file(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							unlink($path);
							$this->m_files->update_file($kode,$judul,$deskripsi,$tanggal,$oleh,$file);
						...
						$deskripsi=$this->input->post('xdeskripsi');
						$oleh=strip_tags($this->input->post('xoleh'));
						$this->m_files->update_file_tanpa_file($kode,$judul,$deskripsi,$tanggal,$oleh);
						echo $this->session->set_flashdata('msg','info');
						redirect('parhaladoo/files');
	            } 
