...
class Wartafix extends CI_Controller{
	...
	function index(){
		...
		$this->load->view('parhaladoo/v_wartafix',$x);
	}
...
// NAMONDING ----------------------------------------------------------------------------------------------------
	function namonding(){
		...
		$x['minggu']=$this->m_kategori->get_all_minggu();
		$x['pengguna']=$this->m_pengguna->get_all_pengguna();
		$this->load->view('parhaladoo/v_wartanamonding',$x);
	}
	...
	function simpan_wartafix_namonding(){
		...
		$this->m_warta->simpan_wartafix($tanggal,$nama,$deskripsi,$kategori,$minggu,$status);
		echo $this->session->set_flashdata('msg','berhasil');
		redirect('parhaladoo/wartafix/namonding');
	}
...
// MENIKAH ----------------------------------------------------------------------------------------------------
	...
	function jmenikah(){
		...
		$x['minggu']=$this->m_kategori->get_all_minggu();
		$x['pengguna']=$this->m_pengguna->get_all_pengguna();
		$this->load->view('parhaladoo/v_wartajmenikah',$x);
	}
	...
	function simpan_wartafix_jmenikah(){
		...
		$this->m_warta->simpan_wartafix($tanggal,$nama,$deskripsi,$kategori,$minggu,$status);
		echo $this->session->set_flashdata('msg','berhasil');
		redirect('parhaladoo/wartafix/jmenikah');
	}
...
// PINDAH ----------------------------------------------------------------------------------------------------
	...
	function jpindah(){
		...
		$x['minggu']=$this->m_kategori->get_all_minggu();
		$x['pengguna']=$this->m_pengguna->get_all_pengguna();
		$this->load->view('parhaladoo/v_wartajpindah',$x);
	}
	...
	function simpan_wartafix_jpindah(){
		...
		$this->m_warta->simpan_wartafix($tanggal,$nama,$deskripsi,$kategori,$minggu,$status);
		echo $this->session->set_flashdata('msg','berhasil');
		redirect('parhaladoo/wartafix/jpindah');
	}
...
// UACPAN SYUKUR ----------------------------------------------------------------------------------------------------
	...
	function hamuliateon(){
		...
		$x['minggu']=$this->m_kategori->get_all_minggu();
		$x['pengguna']=$this->m_pengguna->get_all_pengguna();
		$this->load->view('parhaladoo/v_wartahamuliateon',$x);
	}
	...
	function simpan_wartafix_hamuliateon(){
		...
		$this->m_warta->simpan_wartafix($tanggal,$nama,$deskripsi,$kategori,$minggu,$status);
		echo $this->session->set_flashdata('msg','berhasil');
		redirect('parhaladoo/wartafix/hamuliateon');
	}
...
// WARTA LAIN ----------------------------------------------------------------------------------------------------
	...
	function wartalain(){
		...
		$x['minggu']=$this->m_kategori->get_all_minggu();
		$x['pengguna']=$this->m_pengguna->get_all_pengguna();
		$this->load->view('parhaladoo/v_wartalain',$x);
	}
	...
	function simpan_wartafix_wartalain(){
		...
		$this->m_warta->simpan_wartafix($tanggal,$nama,$deskripsi,$kategori,$minggu,$status);
		echo $this->session->set_flashdata('msg','berhasil');
		redirect('parhaladoo/wartafix/wartalain');
	}
