...
class Komentar extends CI_Controller{
    ...
    function index(){
        $x['data']=$this->db->query("SELECT tbl_komentar.*,renungan_judul,renungan_slug FROM tbl_komentar JOIN tbl_renungan ON komentar_tulisan_id=renungan_id ORDER BY komentar_id DESC");
        $this->load->view('parhaladoo/v_komentar',$x);
    }
