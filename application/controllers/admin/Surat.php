...
class Surat extends CI_Controller{
	...
	function index(){
		...
		$this->load->view('admin/v_skkelahiran',$x);
	}
	...
	function tardidi(){
		...
		$this->load->view('admin/v_sktardidi',$x);
	}
	...
	function sidi(){
		...
		$this->load->view('admin/v_sksidi',$x);
	}
	...
	function jpindah(){
		...
		$this->load->view('admin/v_skjpindah',$x);
	}
	...
	function jmenikah(){
		...
		$this->load->view('admin/v_skjmenikah',$x);
	}
